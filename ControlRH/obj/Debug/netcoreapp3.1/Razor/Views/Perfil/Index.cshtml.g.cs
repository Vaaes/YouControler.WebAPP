#pragma checksum "C:\Users\Cliente\source\repos\TCC\Aplicação\ControlRH\ControlRH\Views\Perfil\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "38514b3209345801f02548d46a90462a82eba9cc"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"38514b3209345801f02548d46a90462a82eba9cc", @"/Views/Perfil/Index.cshtml")]
...
#nullable disable
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "38514b3209345801f02548d46a90462a82eba9cc5497", async() => {
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "38514b3209345801f02548d46a90462a82eba9cc5759", async() => {
                    WriteLiteral(@"
        <div class=""card bg-light"">
            ...
            <div class=""card-body"">
                <div class=""form-row"">
                    ...
                    ");
                    __tagHelperExecutionContext = __tagHelperScopeManager.Begin("select", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "38514b3209345801f02548d46a90462a82eba9cc6344", async() => {
                        WriteLiteral("\r\n                        ");
                        __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "38514b3209345801f02548d46a90462a82eba9cc6644", async() => {
...
#nullable disable
                        WriteLiteral("                            ");
                        __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "38514b3209345801f02548d46a90462a82eba9cc8123", async() => {
#nullable restore
...
<script type=""text/javascript"">
    ...
    function ReturnAllMenusToModal() {
        ...
        AjaxHelper('GET', '/Perfil/ReturnAllMenusToModal', null, function (result) {
            ...
            $.each(result, function (i, item) {
                ...
                var RowContent = '<tr id=""table-row-' + item.id + '""><td class=""text-center""><input class=""appended"" type=""checkbox"" id=""' + item.id + '"" onclick=""CreatePermissionsTds(' + rowContentId + ', (this)); IsChecked();"" ></td><td>' + item.menu + ");
            WriteLiteral(@"'</td></tr>';
    ...
    function UpdateDadosPerfil() {
        ...
        AjaxHelper('PUT', '/Perfil/UpdatePerfil', model, function (result) {
            con");
            WriteLiteral(@"figureSweetSuccess(""Perfil alterado com sucesso!"", ""/Perfil/Index"")
        })
    }
    ...
    function AppendMenusUpdate() {
        AjaxHelper('GET', '/Perfil/ReturnAllMenusToModal', null, function (result) {
            ...
            $.each(result, function (i, item) {
                ...
                tbodyToAppend.appe");
            WriteLiteral(@"nd(RowContent).hide().show();
            })
        })
    }
    ...
    function CreatePermissionsTdsUpdate(menu, checkbox) {
        ...
        if ($(""#"" + checkbox.id).is("":checked"")) {
            ...
            $("".permissionsAppend-update-"" + c");
            WriteLiteral(@"heckbox.id).remove();
        }
    }
    ...
    function AppendMenusAndPermissoesReturned(idProfile) {
        ...
        $.ajax({
            ...
            success: function (result) {
                $.each(result, function (i, item) {
                    ...
                    var newRowContent = '<td class=""text-center permissionsAppend-update-' + checkbox + '""><input type=""checkbox"" id=""td-update-' + checkbox + '-R""></td><td class=""text-center permissionsAppend-update-' + checkbox + '"" ><input type=""checkbox"" class=""permissionsAppend-' + checkbox + '"" id=""td-update-' + checkbox + '-C""></td><td class=""text-center permissionsAppend-update-' + checkbox + '"">");
            WriteLiteral(@"<input type=""checkbox"" class=""permissionsAppend-update-' + checkbox + '"" id=""td-update-' + checkbox + '-U""></td><td class=""text-center permissionsAppend-update-' + checkbox + '""><input type=""checkbox"" class=""permissionsAppend-update-' + checkbox + '"" id=""td-update-' + checkbox + '-D""></td>';
                    $(""#"" + menu).append(newRowContent);
        ...
        ");
            WriteLiteral(@"                    if (item.deletar == 1) { $('#td-update-update-' + item.idMenu + '-D').prop('checked', true); }
                        })
                    },
                    error: function (error) {
                        Swal.fire('Não foi possível cadastrar os menus, contate o suporte.', '', 'error')
    ...
    function VerificaUsuarioPerfil(IdNivelAcesso, role) {
        ...
        AjaxHelper('GET', '/Perfil/ListVerificaAcessoPerfil', model, function (result) {
            if (result) {
                ...
                Swal.fire({
                    title: role,
                    text: ""O perfil: "" + role + "" está vinculado a algum");
            WriteLiteral(@" usuário, portanto não é possivel deleta-lo!"",
                    icon: 'warning',
                    showCancelButton: false,
                    confirmButtonColor: '#28a745',
                    cancelButtonColor: '#dc3545',
