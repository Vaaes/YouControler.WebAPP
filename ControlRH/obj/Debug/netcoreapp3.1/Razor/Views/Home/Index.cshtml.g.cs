#pragma checksum "C:\Users\Cliente\source\repos\TCC\Aplicação\ControlRH\ControlRH\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "312a21a7527efcd1927845b261f52b437d372bc9"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"312a21a7527efcd1927845b261f52b437d372bc9", @"/Views/Home/Index.cshtml")]
    ...
    function updatePassword() {
        ...
        if ($('#confirma-pass').val() == $('#pass').val()) {
            AjaxHelper('PUT', '/Home/ChangePassword', model, function (result) {
                if (result) {
                    configureSweetSuccess(""Senha alterada com sucesso!"", ""/F");
            WriteLiteral("uncionario/Index\")\r\n                }\r\n            })\r\n        }\r\n    }\r\n\r\n    function OnChangeValidation(campo) {\r\n        if ($(campo).val() != \"\") {\r\n            $(campo).css(\"border-color\", \"\")\r\n        }\r\n    }\r\n\r\n</script>");
        }
