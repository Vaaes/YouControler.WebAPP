#pragma checksum "C:\Users\Cliente\source\repos\_YouController\Aplicação\ControlRH\ControlRH\Views\Perfil\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0b456a75f9ed6a6d6e1c8a622bedc2d22c6f8e9e"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0b456a75f9ed6a6d6e1c8a622bedc2d22c6f8e9e", @"/Views/Perfil/Index.cshtml")]
...
#nullable disable
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "0b456a75f9ed6a6d6e1c8a622bedc2d22c6f8e9e5541", async() => {
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "0b456a75f9ed6a6d6e1c8a622bedc2d22c6f8e9e5803", async() => {
                    WriteLiteral(@"
        <div class=""card bg-light"">
            ...
            <div class=""card-body"">
                <div class=""form-row"">
                    ...
                    ");
                    __tagHelperExecutionContext = __tagHelperScopeManager.Begin("select", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "0b456a75f9ed6a6d6e1c8a622bedc2d22c6f8e9e6388", async() => {
                        WriteLiteral("\r\n                        ");
                        __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "0b456a75f9ed6a6d6e1c8a622bedc2d22c6f8e9e6688", async() => {
...
#nullable disable
                        WriteLiteral("                            ");
                        __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "0b456a75f9ed6a6d6e1c8a622bedc2d22c6f8e9e8178", async() => {
#nullable restore
...
#nullable restore
#line 49 "C:\Users\Cliente\source\repos\_YouController\Aplicação\ControlRH\ControlRH\Views\Perfil\Index.cshtml"
...
#nullable disable
                ...
                BeginWriteAttribute("onclick", " onclick=\"", 2222, "\"", 2263, 6);
                WriteAttributeValue("", 2232, "Excluir(", 2232, 8, true);
#nullable restore
...
#nullable disable
                ...
                WriteAttributeValue(" ", 2249, "\'", 2250, 2, true);
#nullable restore
#line 50 "C:\Users\Cliente\source\repos\_YouController\Aplicação\ControlRH\ControlRH\Views\Perfil\Index.cshtml"
WriteAttributeValue("", 2251, item.Role, 2251, 10, false);
...
#nullable disable
    ...
    <div class=""modal");
                WriteLiteral(@""" id=""modal-update-menus-permissoes"">
        <div class=""modal-dialog modal-dialog-centered modal-lg"">
            <div class=""modal-content"">
                <div class=""modal-header"">
                    <h4 class=""modal-title"">Inserir</h4>
...
<script type=""text/javascript"">
    ...
    function IncluirDadosPerfil() {
        ...
        AjaxHelper('POST', '/Perfil/CreateNewPerfil', model, function (result) {
            ...
            divToAppend.append('<h5 class=""form-check-label appended"">' + result + '<");
            WriteLiteral(@"/h5>')
        ...
        function IncluirAposRetornarPerfil(id) {
            ...
            function IncluirDadosMenu(idMenu, IdPerfil, Acesso, C, R, U, D) {
                ...
                $.ajax({
                  ...
                  ");
            WriteLiteral(@"  data: { model: model, modelPermissoes: permissao},
    ...
    ");
            WriteLiteral(@"        confirmButtonText: 'Sim, deletar!'
        }).then((result) => {
                ...
                $.ajax({
                    ...
                    error: function (error) {
                        Swal.fire(
                            'Erro!',
                          ");
            WriteLiteral(@"  'Não foi possível deletar esse perfil, entre em contato com o suporte.',
                            'error'
                        )
                    }
                });
    ...
    function OpenModalMenusAndPermissions(idProfile, role) {
     ...
     ");
            WriteLiteral(@"   AppendMenusAndPermissoesReturned(idProfile)
    }
    ...
    function CreatePermissionsTdsUpdate(menu, checkbox) {
        ...
        var newRowContent = '<td class=""text-center permissionsAppend-update-' + checkbox.id + '""><input type=""checkbox"" id=""td-update-' + checkbox.id + '-R""></td><td class=""t");
            WriteLiteral(@"ext-center permissionsAppend-update-' + checkbox.id + '"" ><input type=""checkbox"" class=""permissionsAppend-' + checkbox.id + '"" id=""td-update-' + checkbox.id + '-C""></td><td class=""text-center permissionsAppend-update-' + checkbox.id + '""><input type=""checkbox"" class=""permissionsAppend-update-' + checkbox.id + '"" id=""td-update-' + checkbox.id + '-U""></td><td class=""text-center permissionsAppend-update-' + checkbox.id + '""><input type=""checkbox"" class=""permissionsAppend-update-' + checkbox.id + '"" id=""td-update-' + checkbox.id + '-D""></td>';
        if ($(""#"" + checkbox.id).is("":checked"")) {
            $(""#"" + menu).append(newRowContent);
        }
        else {
    ...
    function AppendMenusAndPermissoesReturned(idProfile) {
        ...
        AjaxHelper('GET', '/Perfil/ReturnAllMenusByProfileId', model, function (result) {
            var trs = $(""#list-all-m");
            WriteLiteral(@"enus-update"").find(""tbody>tr>td"");
        })

        AjaxHelper('GET', '/Perfil/ReturnAllPermissionsByProfileId', model, function (result) {
