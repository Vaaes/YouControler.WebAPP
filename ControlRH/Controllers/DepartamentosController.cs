    ...
    public class DepartamentosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            try
            {
                ...
                model.GestorReturnSelect = await _depart.GetGestor(HttpContext.Session.GetString("SessionToken"));
        ...
        public async Task<IActionResult> DeleteDepartamento(int id)
        {
            try
            {
                ...
                await _depart.Delete(id, HttpContext.Session.GetString("SessionToken"));
